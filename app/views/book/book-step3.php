...
<body class="scroll-smooth flex flex-col h-screen justify-between items-center">
  ...
  <header class="w-full bg-[var(--gold)] h-auto flex items-center px-20 text-white mb-10 sm:mb-20">
